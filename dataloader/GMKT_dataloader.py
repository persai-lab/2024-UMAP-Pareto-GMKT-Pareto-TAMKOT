...
class GMKT_DataLoader:
    ...
    def read_graph_neighbor(self, data):
        ...
        # self.neighbors_q_train_data, self.neighbors_l_train_data, \
        # self.neighbors_q_test_data, self.neighbors_l_test_data = self.generate_graph_data(
        #     q_q_neighbors, q_l_neighbors,
        #     l_q_neighbors, l_l_neighbors,
        #     max_q_q_neighbors,
        #     max_q_l_neighbors, max_l_q_neighbors,
        #     max_l_l_neighbors)
